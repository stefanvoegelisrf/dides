<template>
    <main class="overflow-hidden">
        ...
        <h2 class="absolute bottom-20 xl:bottom-28 left-4 lg:left-9 xl:left-1/3 m-plus-1p-regular">Black Mirror Series 3, Episode 4</h2>
        <h2 class="absolute bottom-20 xl:bottom-28 right-4 lg:right-9 xl:right-1/3 m-plus-1p-regular">Directed by Owen Harris</h2>
    </main>
</template>
<style scoped>
@font-face {
